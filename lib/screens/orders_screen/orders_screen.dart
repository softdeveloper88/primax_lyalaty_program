...
import 'package:primax_lyalaty_program/screens/orders_screen/user_order_details_screen.dart';
import 'package:primax_lyalaty_program/widgets/comman_back_button.dart';

import '../dashboard_screen/admin/orders_screen/order_details_screen.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('orders')
            .where('userId', isEqualTo: sharedPref.getString('user_id')) // Replace dynamically
        ...
        builder: (context, snapshot) {
          ...
          if (orders.isEmpty) {
            return Center(child: Text("No Order Found ",style: TextStyle(fontSize: 16,),));
          }
          print('orders $orders');
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          UserOrderDetailsScreen(orderId:orderId).launch(context,pageRouteAnimation: PageRouteAnimation.Slide);
